...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.aguedagg.weatherapp.di.module.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.aguedagg.weatherapp.di.module.GlideOptions().apply(toSet));
    }
  }
}
